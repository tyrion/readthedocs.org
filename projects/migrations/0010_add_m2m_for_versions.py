...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field versions on 'Project'
        db.create_table('projects_project_versions', (
        ...
        db.create_unique('projects_project_versions', ['from_project_id', 'to_project_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field versions on 'Project'
        db.delete_table('projects_project_versions')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'versions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'versions_rel_+'", 'blank': 'True', 'to': "orm['projects.Project']"})
        }
    }
